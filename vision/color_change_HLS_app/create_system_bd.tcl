...
# Add Custom HLS IP
#--------------------------------------------------------------
# set_property ip_repo_paths [file join $script_dir "./hls_ip_repo"] [current_project]
# update_ip_catalog
...
# # include color change Verilog file
# add_files -norecurse $script_dir/vivado_source/colour_change_btn.v
# create_bd_cell -type module -reference colour_change colour_change_0
...
# connect_bd_net -net v_axi4s_vid_out_0_vid_active_video [get_bd_pins v_axi4s_vid_out_0/vid_active_video] [get_bd_pins colour_change_0/i_vid_VDE]
# connect_bd_net -net v_axi4s_vid_out_0_vid_data [get_bd_pins v_axi4s_vid_out_0/vid_data] [get_bd_pins colour_change_0/i_vid_data]
# connect_bd_net -net v_axi4s_vid_out_0_vid_hsync [get_bd_pins v_axi4s_vid_out_0/vid_hsync] [get_bd_pins colour_change_0/i_vid_hsync]
# connect_bd_net -net v_axi4s_vid_out_0_vid_vsync [get_bd_pins v_axi4s_vid_out_0/vid_vsync] [get_bd_pins colour_change_0/i_vid_vsync]
# connect_bd_net -net v_axi4s_vid_out_0_locked [get_bd_pins colour_change_0/n_rst] [get_bd_pins v_axi4s_vid_out_0/locked]
# connect_bd_net [get_bd_pins colour_change_0/clk] [get_bd_pins DVIClocking_0/PixelClk]
# connect_bd_net -net colour_change_0_o_vid_data [get_bd_pins colour_change_0/o_vid_data] [get_bd_pins rgb2dvi_0/vid_pData]
# connect_bd_net -net colour_change_0_o_vid_hsync [get_bd_pins colour_change_0/o_vid_hsync] [get_bd_pins rgb2dvi_0/vid_pHSync]
# connect_bd_net -net colour_change_0_o_vid_vsync [get_bd_pins colour_change_0/o_vid_vsync] [get_bd_pins rgb2dvi_0/vid_pVSync]
# connect_bd_net -net colour_change_0_o_vid_VDE [get_bd_pins colour_change_0/o_vid_VDE] [get_bd_pins rgb2dvi_0/vid_pVDE]

# startgroup
# make_bd_pins_external  [get_bd_cells colour_change_0]
# make_bd_intf_pins_external  [get_bd_cells colour_change_0]
